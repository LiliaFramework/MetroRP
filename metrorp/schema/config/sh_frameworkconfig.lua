...
lia.config.SchemaYear = 2035 -- Year When Schema Happens
lia.config.DefaultMoney = 50 -- Default starting amount of in-game currency
...
lia.config.GamemodeName = "MetroRP"
-- TPose Fixer
